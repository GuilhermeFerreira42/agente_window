...
import {
  isChatCentered,
  isEditorContentVisible,
  isTabBarVisible,
  isTabCloseable,
  resolveDetailPanelVisible,
  resolveSidePaneState,
} from '../domain/sidePane'
import type { EditorTab } from '../types'

const fileTab: EditorTab = { id: 't1', type: 'file', title: 'Files', path: 'a.ts' }
const diffTab: EditorTab = { id: 't2', type: 'diff', title: 'Changes' }
const browserTab: EditorTab = { id: 't3', type: 'browser', title: 'Browser', browserId: 'b1' }
