...
## Seu vídeo novo [02:35] mostra layout totalmente diferente lado a lado original vs réplica
- Original tem border-radius 8px, background var(--vscode-agentsPanel-background), sidebar transparente
- Réplica tem CSS simples sem tokens
- Sessions Part deveria ser flexível absorvendo resize, hoje não é
