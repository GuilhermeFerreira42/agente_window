...
4. `docs/12_DOCUMENTACAO_VIVA.md` — seção 2026-09-20 LEGO (obrigatória para entender princípio de transplante)
   - **Estado vigente da 4.4 (2026-09-24):** ler primeiro o topo de `docs/12-DOCUMENTACAO-VIVA.md` ("Estado atual da rodada") + entrada "2026-09-24 — Sincronização Pós-Auditoria 4.4" — 4.4 é **PARCIAL** (10/11 PASS, HEAD `0d86656`); débitos adiados no Épico D2 de `docs/05`; kanban por sub-fatia em `docs/11`.
