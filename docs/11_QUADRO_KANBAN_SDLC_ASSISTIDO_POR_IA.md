...
**Onda:** 4 | **Épico:** D — Explorer (+ C/F/E conforme sub-fatia) | **Prioridade:** P0 | **Status:** Em execução (4.1–4.5 ✅; **4.6 implementada, homologação pendente**) | **Depende de:** FATIA-01 e FATIA-02 | **Doc:** `docs/engenharia_reversa/FATIA-04_VIDEO_COMPLETO/` (19 arquivos, `04_00` a `04_18`)
...
**Ordem obrigatória:** 4.1 → 4.2 → 4.3 → 4.4 ✅ → 4.5 ✅ → **4.6 (implementada 2026-09-26; homologação humana pendente) → 4.7** → 4.9 (4.8 planejado; cada uma só começa com a anterior validada). **Débitos e fontes por item:** `docs/12` entrada 2026-09-24 §B; épico "Refinamento UX Explorer" em `docs/05`.
...
| 04 | Explorer Completo + Editor em anexo + Browser com IA (9 sub-fatias) | Em execução — 4.1–4.5 ✅; **4.6 implementada (aguarda checklist humano)** | Próximo: checklist do usuário no Windows → 4.6 CONCLUÍDA → 4.7 (editor em anexo + AttachArea/sash + reveal na linha, D2.19/D2.20). Medidas em `04_17`, plano em `04_18`, aceite em `04_13`, estado real em `docs/12` 2026-09-24 |
