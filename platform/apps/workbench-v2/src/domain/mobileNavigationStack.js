...
export const EMPTY_NAVIGATION_STACK = { layers: [] };
/** A camada do topo (ativa), ou undefined se a pilha está vazia. */
export function topLayer(stack) {
    return stack.layers[stack.layers.length - 1];
}
export function hasLayers(stack) {
 ...
 */
export function pushLayer(stack, layer) {
 ...
 */
export function navigateBack(stack) {
...
export function dismissLayer(stack, id) {
 ...
 */
export function resetForSessionSwitch() {
    return EMPTY_NAVIGATION_STACK;
}
//# sourceMappingURL=mobileNavigationStack.js.map