...
import { aggregateSessionTypes, commitDraft, createManagementState, discardDraft, hasPendingDraft, openDraft, registerProvider, resolvableWorkspaces, resolveProvider, selectProviderForNewSession, unregisterProvider, } from '../domain/sessionsManagement';
const copilot = { id: 'copilot', label: 'Copilot Chat', order: 0, sessionTypes: ['chat', 'quick-chat'] };
const agentHost = { id: 'agent-host', label: 'Agent Host', order: 1, sessionTypes: ['chat', 'automation'], workspaces: ['vscode-main'] };
const remote = { id: 'remote', label: 'Remote Agent Host', order: 2, sessionTypes: ['chat'], workspaces: ['sessions'] };
function seeded() {
...
describe('sessionsManagement (R-001/R-002/R-003)', () => {
    ...
    it('abre, confirma e descarta drafts pendentes (R-003)', () => {
        ...
        const unchanged = openDraft(state, { id: 'd2', kind: 'chat', providerId: 'ghost' });
...
//# sourceMappingURL=sessionsManagement.test.js.map