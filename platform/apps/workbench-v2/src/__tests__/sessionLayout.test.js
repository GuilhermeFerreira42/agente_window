...
import { DEFAULT_SESSION_LAYOUT, captureSessionLayout, forgetSessionLayout, restoreSessionLayout, } from '../domain/sessionLayout';
const visibleFiles = { auxiliaryVisible: true, activeViewContainerId: 'files' };
describe('sessionLayout (E4 — estado por sessão)', () => {
    ...
    it('usa o fallback fornecido (preferência global) para sessões novas', () => {
        const fallback = { auxiliaryVisible: true, activeViewContainerId: 'changes' };
...
//# sourceMappingURL=sessionLayout.test.js.map