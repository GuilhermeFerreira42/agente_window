...
import { addVisibleSession, applySyncSuppression, createSessionsServiceState, isRealSwitch, multipleSessionsVisible, removeVisibleSession, reorderVisibleSessions, setActiveChat, setActiveSession, } from '../domain/sessionsService';
describe('sessionsService (E14 — Sessions Part model)', () => {
    ...
    it('sync é suprimido e limpa entradas das visíveis com múltiplas sessões', () => {
        ...
        const res = applySyncSuppression(s, { s1: 'a', s2: 'b', s3: 'keep' }, { s1: true, s2: false, s3: true });
...
//# sourceMappingURL=sessionsService.test.js.map