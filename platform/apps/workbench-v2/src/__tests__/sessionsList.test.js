...
import { EMPTY_FILTERS, applyWorkspaceCapping, buildSessionsList, placeSession, sessionMatchesFilters, } from '../domain/sessionsList';
...
describe('composite filters', () => {
    ...
    it('composes status, provider and read-state filters', () => {
        const f = { ...EMPTY_FILTERS, statuses: ['completed'], providers: ['openai'], readState: 'unread' };
...
describe('buildSessionsList', () => {
    ...
    it('keeps the active session visible even when filtered out', () => {
        const filters = { ...EMPTY_FILTERS, query: 'inexistente' };
...
//# sourceMappingURL=sessionsList.test.js.map