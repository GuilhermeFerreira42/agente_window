...
import { EMPTY_NAVIGATION_STACK, dismissLayer, hasLayers, navigateBack, pushLayer, resetForSessionSwitch, topLayer, } from '../domain/mobileNavigationStack';
const drawer = { id: 'details', kind: 'drawer', label: 'Detalhes' };
const picker = { id: 'picker', kind: 'picker', label: 'Sessões' };
const editor = { id: 'editor', kind: 'full-screen-editor', label: 'Editor' };
...
//# sourceMappingURL=mobileNavigationStack.test.js.map