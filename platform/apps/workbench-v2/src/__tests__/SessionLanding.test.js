...
describe('SessionLanding (estado inicial vazio)', () => {
    it('mostra o cabeçalho de nova sessão e o input centralizado', () => {
        render(_jsx(SessionLanding, { workspace: "vscode-main", onSubmit: () => { } }));
    ...
    it('envia o texto ao clicar em enviar', async () => {
        ...
        render(_jsx(SessionLanding, { workspace: "vscode-main", onSubmit: onSubmit }));
...
//# sourceMappingURL=SessionLanding.test.js.map