...
export const marketplaceDiscovery = {
    id: 'marketplace',
    priority: 100,
    plugins: [
        {
...
export const configuredDiscovery = {
    id: 'configured',
    priority: 50,
    plugins: [
        {
...
export const initialPluginDiscoveries = [marketplaceDiscovery, configuredDiscovery];
//# sourceMappingURL=agentPluginsData.js.map